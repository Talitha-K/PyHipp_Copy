...
#SBATCH -e rplplslurm.%N.%j.err # STDERR

# LOAD MODULES, INSERT CODE, AND RUN YOUR PROGRAMS HERE
source /data/miniconda3/etc/profile.d/conda.sh
conda activate env1
export PYTHONPATH="/data/src/PyHipp_Copy:$PYTHONPATH"
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:363647120340:awsnotify --message "RPLParallelJobDone"
